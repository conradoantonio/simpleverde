        ...
        <div class="span12">
            <div class="grid simple" style="display: none" id="contenedor_empleados">
                <ul class="nav nav-tabs" id="tab-01">
                    <li class="active"><a href="#form_empleado">Formulario empleado</a></li>
                    @if ($empleado)
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="form_empleado">
                        <div class="row">
                            <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $('body').delegate('.detalle_deduccion','click', function() {
        ...
        var table = $('table#tb-detalle-deduccion tbody');
        table.children().remove();
        for (var key in data) {
            if (data.hasOwnProperty(key)) {
                table.append(
                    "<tr>" +
                        "<td class='hide'>"+data[key].id+"</td>" +
                        "<td>$"+data[key].cantidad+"</td>" +
                        "<td>"+(data[key].status == 0 ? "<span class='label label-danger'>Sin pagar</span>" : "<span class='label label-success'>Pagado</span>")+"</td>" +
                    "</tr>"
                );
            }
        }

        $('div#md-detalle-deducciones').modal();
    });
