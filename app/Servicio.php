...
class Servicio extends Model
{
    ...
    protected $fillable = [
        ...
        'ciudad', 'estado', 'pais', 'codigo_postal', 'comentarios', 'datetime_formated', 'repartidor_id', 'status', 'tipo_pago', 'is_finished', 
        'puntuacion', 'codigo_liberacion', 'last_digits', 'created_at'
    ];
    ...
    public static function obtener_pedidos()
    {
        ...
        ->leftJoin('estilistas', 'servicios.repartidor_id', '=', 'estilistas.id')
        ->get();
